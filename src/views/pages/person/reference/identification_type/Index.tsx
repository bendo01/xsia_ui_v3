...
import { PersonReferenceControllerIdentificationTypeIndex, PersonReferenceControllerIdentificationTypeUpsert, PersonReferenceControllerIdentificationTypeDelete } from "../../../../../controllers/person/reference/PersonReferenceIdentificationTypeController";

export default function PersonReferenceIdentificationTypeIndex() {
    ...
    async function fetchUpsertData(event: Event) {
        event.preventDefault();
        // console.log(formInput);
        let response: UpsertDeleteMessage = await PersonReferenceControllerIdentificationTypeUpsert(formInput);
        if (!response.is_error) {
            ...
            let pagination_response = await PersonReferenceControllerIdentificationTypeIndex(pagination);
    ...
    async function fetchDeleteData(event: Event) {
        ...
        // console.log(formInput);
        let response: UpsertDeleteMessage = await PersonReferenceControllerIdentificationTypeDelete(formInput);
        if (!response.is_error) {
            HSOverlay.close("#delete-modal");
            toast.custom((t) => <ToastSuccess message={response.message} toast_id={t.id} />, {
                duration: 10000,
    ...
    onMount(async () => {
        PersonReferenceControllerIdentificationTypeIndex(pagination).then((response) => {
            setModel(response);
                ...
                <div id="page-content" class="flex-1 p-4">
                    <div class="flex items-center justify-between mx-auto">
                        <div class="inline-flex items-center">
                            <h2 class="text-xl">Tabel Referensi Jenis Identifikasi</h2>
                        </div>
                        <div class="inline-flex items-center">
                            <button
                                type="button"
