...
import { PersonReferenceControllerReligionIndex, PersonReferenceControllerReligionUpsert, PersonReferenceControllerReligionDelete } from "../../../../../controllers/person/reference/PersonReferenceReligionController";

export default function PersonReferenceReligionIndex() {
    ...
    async function fetchUpsertData(event: Event) {
        event.preventDefault();
        // console.log(formInput);
        let response: UpsertDeleteMessage = await PersonReferenceControllerReligionUpsert(formInput);
        if (!response.is_error) {
            ...
            let pagination_response = await PersonReferenceControllerReligionIndex(pagination);
    ...
    async function fetchDeleteData(event: Event) {
        ...
        // console.log(formInput);
        let response: UpsertDeleteMessage = await PersonReferenceControllerReligionDelete(formInput);
        if (!response.is_error) {
            HSOverlay.close("#delete-modal");
            toast.custom((t) => <ToastSuccess message={response.message} toast_id={t.id} />, {
                duration: 10000,
    ...
    onMount(async () => {
        PersonReferenceControllerReligionIndex(pagination).then((response) => {
            setModel(response);
                ...
                <div id="page-content" class="flex-1 p-4">
                    <div class="flex items-center justify-between mx-auto">
                        <div class="inline-flex items-center">
                            <h2 class="text-xl">Tabel Referensi Agama</h2>
                        </div>
                        <div class="inline-flex items-center">
                            <button
                                type="button"
