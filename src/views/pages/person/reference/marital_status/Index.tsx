...
import { PersonReferenceControllerMaritalStatusIndex, PersonReferenceControllerMaritalStatusUpsert, PersonReferenceControllerMaritalStatusDelete } from "../../../../../controllers/person/reference/PersonReferenceMaritalStatusController";

export default function PersonReferenceMaritalStatusIndex() {
    ...
    async function fetchUpsertData(event: Event) {
        event.preventDefault();
        // console.log(formInput);
        let response: UpsertDeleteMessage = await PersonReferenceControllerMaritalStatusUpsert(formInput);
        if (!response.is_error) {
            ...
            let pagination_response = await PersonReferenceControllerMaritalStatusIndex(pagination);
    ...
    async function fetchDeleteData(event: Event) {
        ...
        // console.log(formInput);
        let response: UpsertDeleteMessage = await PersonReferenceControllerMaritalStatusDelete(formInput);
        if (!response.is_error) {
            HSOverlay.close("#delete-modal");
            toast.custom((t) => <ToastSuccess message={response.message} toast_id={t.id} />, {
                duration: 10000,
    ...
    onMount(async () => {
        PersonReferenceControllerMaritalStatusIndex(pagination).then((response) => {
            setModel(response);
                ...
                <div id="page-content" class="flex-1 p-4">
                    <div class="flex items-center justify-between mx-auto">
                        <div class="inline-flex items-center">
                            <h2 class="text-xl">Tabel Referensi Status Pernikahan</h2>
                        </div>
                        <div class="inline-flex items-center">
                            <button
                                type="button"
